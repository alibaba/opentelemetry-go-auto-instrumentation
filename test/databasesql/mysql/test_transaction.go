...
func main() {
	...
	verifier.WaitAndAssertTraces(func(stubs []tracetest.SpanStubs) {
		...
		verifier.VerifyDbAttributes(stubs[2][0], "INSERT users", "mysql", "127.0.0.1", "INSERT INTO users (id, name, age) VALUES ( ?, ?, ?)", "INSERT", "users")
		verifier.VerifyDbAttributes(stubs[3][0], "START", "mysql", "127.0.0.1", "START TRANSACTION", "START", "")
		verifier.VerifyDbAttributes(stubs[4][0], "INSERT users", "mysql", "127.0.0.1", "INSERT INTO users (id, name, age) VALUES ( ?, ?, ? )", "INSERT", "users")
		verifier.VerifyDbAttributes(stubs[5][0], "UPDATE users", "mysql", "127.0.0.1", "UPDATE users SET name = ? WHERE id = ?", "UPDATE", "users")
