...
func init() {
	TestCases = append(TestCases, NewGeneralTestCase("gorm_crud_test", gorm_module_name, "v1.23.0", "v1.24.6", "1.18", "", TestGormCrud),
		NewMuzzleTestCase("gorm_muzzle_test", gorm_dependency_name, gorm_module_name, "v1.23.0", "v1.24.6", "1.18", "", []string{"test_gorm_crud.go"}),
		NewLatestDepthTestCase("gorm_latestdepth_test", gorm_dependency_name, gorm_module_name, "v1.23.0", "v1.24.6", "1.18", "", TestGormCrud))
}
