...
func (x *GreetRequest) GetError() bool {
	if x != nil {
		return x.Error
	}
	return false
...
const file_greet_proto_rawDesc = "" +
	...
	"\fGreetService\x124\n" +
	"\x05Greet\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponse\"\x00B\bZ\x06.;mainb\x06proto3"
