...
func grpcClientOnEnter(call grpc.CallContext, ctx context.Context, target string, opts ...grpc.DialOption) {
...
func grpcClientOnExit(call grpc.CallContext, cc *grpc.ClientConn, err error) {
	return
}
